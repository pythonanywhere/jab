...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Post.published'
        raise RuntimeError("Cannot reverse this migration. 'Post.published' and its values cannot be restored.")
    models = {
        'auth.group': {
